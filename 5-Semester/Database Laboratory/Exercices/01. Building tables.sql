...
CREATE UNIQUE INDEX pk_id_localizacao ON tb_localizacao (id_localizacao);
...
CREATE SEQUENCE seq_localizacao
 START WITH 3300 INCREMENT BY 100 MAXVALUE 9900 NOCACHE NOCYCLE;
...
CREATE SEQUENCE seq_departamento
 START WITH 280 INCREMENT BY 10 MAXVALUE 9990 NOCACHE NOCYCLE;
...
CREATE UNIQUE INDEX pk_id_emp ON tb_empregado (id_empregado);
...
CREATE SEQUENCE seq_empregado START WITH 207 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE UNIQUE INDEX pk_hist_emp_id_emp ON tb_historico_funcao (id_empregado, data_inicio);
